...
# ponytail: _is_etf_listed now lives in backtest.loaders._symbol_utils (shared
# across loaders — same SH/SZ prefix set as the old Issue #50 constant). Only
# the forex fallback stays here: akshare's symbol_market_map import can fail at
# runtime, so we keep a static set to fall back on.
