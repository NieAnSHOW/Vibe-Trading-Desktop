    ...
    tauri_build::try_build(
        tauri_build::Attributes::new().app_manifest(
            tauri_build::AppManifest::new().commands(&[
                ...
                "console_stop_channels",
                "console_run_pairing_command",
                "console_weixin_login_start",
                "console_weixin_login_status",
                "console_get_llm_settings",
                "console_set_llm_settings",
                "console_get_data_source_settings",
                "console_set_data_source_settings",
